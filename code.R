getwd()
setwd("/home/arghya/Documents/projects/kaggle/telecom/main")
library(stats)
library(caTools)
library(Amelia)
library(dplyr)
# read the telecom dataset input file
telecomDataframe <- read.csv("Telco-Customer-Churn_data.csv")
...
missmap(telecomDataframe,col=c("blue","green"))
...
# The value of the following columns affecting the model 
#and introducing the NA value for "No phone service" and  and "No internet service" 
#need to cleanup the data for these columns
#MultipleLine,OnlineSecurity,OnlineBackup,DeviceProtection,
